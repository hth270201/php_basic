            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
                                <li><a href="index.php?pages=blog-details">Blog Details</a></li>
                                <li><a href="index.php?pages=shopping-cart">Shopping Cart</a></li>
                                <li><a href="index.php?pages=check-out">Checkout</a></li>
                                <li><a href="index.php?pages=faq">Faq</a></li>
                                <li><a href="index.php?pages=register">Register</a></li>
                                <li><a href="index.php?pages=logine">Login</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
